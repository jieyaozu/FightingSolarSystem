...
{
	//新增
	Config::sharedConfig()->setOptions(true);
	...
	//-----------------------
	CCMenuItemFont *menuTitleEffect = CCMenuItemFont::create("Effect");
    menuTitleEffect->setFontName("Arial");
    menuTitleEffect->setFontSize(18);
    menuTitleEffect->setEnabled(false);

	CCMenuItemFont::setFontName("Arial");
    CCMenuItemFont::setFontSize(26);
    CCMenuItemToggle *toggleEffect = CCMenuItemToggle::createWithTarget(this, menu_selector(Options::setOptionsEffect), CCMenuItemFont::create("On"),CCMenuItemFont::create("Off"), NULL);
   
	int selectId2 = Config::sharedConfig()->getEffectState()? 0 : 1;
    toggleEffect->setSelectedIndex(selectId2);
	//---------------------------------
    ...
    CCMenu *menu = CCMenu::create( menuTitle, toggle,menuTitleEffect,toggleEffect, goBack, NULL);
...
void Options::setOptions(CCObject* obj)
{
...
void Options::setOptionsEffect(CCObject* obj)
{
    bool tmpSound = Config::sharedConfig()->getEffectState();
    Config::sharedConfig()->updateEffectState(!tmpSound);
